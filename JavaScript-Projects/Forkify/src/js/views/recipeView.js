...
class RecipeView extends View {
  ...
  //Method to generate markup for the recipe's ingredients
  ...
  //Method to attach event listener to the bookmark button
  addBookmarkHandler(handler) {
    this._parentElement.addEventListener("click", function (e) {
      const btnClicked = e.target.closest(".btn--round");
